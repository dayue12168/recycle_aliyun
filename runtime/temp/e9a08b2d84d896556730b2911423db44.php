<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"/var/www/html/recycle/public/../app/index/view/index/index.html";i:1541579068;s:54:"/var/www/html/recycle/app/index/view/layoutextend.html";i:1541579068;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div id="con">
    ...
    <button type="button" class="btn  btn-xs reload"><i class="fa fa-refresh" aria-hidden="true"></i>刷新地图</button>
...
<footer>
    <div class='foot flex-box flex-a flex-col-c'>
        <a href="<?php echo url('Index/index'); ?>" class="flex-col flex-col-c flex-wrap flex-a"><img src="/static/index/images/lj_1.png" data-src="../images/lj_11.png" alt=""><span>垃圾桶查看</span></a>
