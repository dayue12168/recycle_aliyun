...
use lib\aliyun\Constant\HttpSchema;
use lib\aliyun\Constant\SystemHeader;
use lib\aliyun\Http\HttpResponse;
...
class HttpUtil
{
    ...
    private static function InitHttpRequest($host, $path, $method, $readtimeout, $connectTimeout, $headers, $querys)
    {
        ...
        // var_dump( CURLOPT_FAILONERROR);
        // var_dump( CURLOPT_RETURNTRANSFER);
        // var_dump( $readtimeout);
        // var_dump( $connectTimeout);
